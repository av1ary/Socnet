    ...
    return (
       <div className={classes.UserInfo}>
           ...
           <ul className={classes.actbuttonsul}>
               <li>
                   <div className={classes.actbutton}><a href=''> <i className='bx bx-dots-horizontal-rounded' size='lg'> </i></a></div>

               </li>
               <li>
                   <div className={classes.actbutton}><a href=''> <i className='bx bx-message-square-dots' size='lg'> </i></a></div>

               </li>
               <li>
                   <div className={classes.actbutton}> <a href=''> <i className='bx bx-plus' size='lg'> <span>Add Friend </span></i> </a> </div>
